...
public class GoodsService {
     ...
     * @param spuId
     */
    public void changeToLower(Long spuId) {

        this.spuMapper.updateToLowerBySpuId(spuId);
    }
     ...
     * @param spuId
     */
    public void changeToUpper(Long spuId) {

        this.spuMapper.updateToUpperBySpuId(spuId);
    }
